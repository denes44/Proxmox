...
<<<<<<< HEAD:misc/zwave-copy-data.sh
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/denes44/Proxmox/main/misc/zwave-copy-data.sh)"
=======
clear
if ! command -v pveversion >/dev/null 2>&1; then echo -e "⚠️  Run from the Proxmox Shell"; exit; fi
>>>>>>> 6192f0d48c4d3b531f422e24f2f68fbe1f74e55b:misc/copy-data/zwavejs2mqtt-copy-data-zwavejsui.sh
while true; do
