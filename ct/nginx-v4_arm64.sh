...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/denes44/Proxmox/main/ct/create_lxc_arm64.sh)" || exit
msg_info "Starting LXC Container"
pct start $CTID
msg_ok "Started LXC Container"
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/denes44/Proxmox/main/misc/fix_lxc.sh)" || exit
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/denes44/Proxmox/main/setup/nginx-install.sh)" || exit
