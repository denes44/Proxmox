...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/denes44/Proxmox/main/ct/create_lxc.sh)" || exit
...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/denes44/Proxmox/main/setup/podman-homeassistant-install.sh)" || exit
